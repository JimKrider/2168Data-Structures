...
{   private int M, N; 
    ...
    {
        super("A MAZE");
        String integers = JOptionPane.showInputDialog("Enter #rows and #columns.");
    ...
    class ShowPathListener implements ActionListener
    {
    	...
    	{
           show = 1; 
           setTitle("A MAZE WITH PATH");
           repaint();
        }
    }/*End Of ShowPathListener*/
    ...
    public void showPath(LinkedList<Point> P){ Path = P; repaint(); }/*End Of ShowPath*/
